...
//       {/* Add Form */}
//       {showForm && (
//         <form onSubmit={handleSubmit} className="mb-6 p-6 bg-green-50 rounded-lg">
//           <h3 className="text-lg font-semibold mb-4 text-green-900">تسجيل مساعدة جديدة</h3>
...
//               <th className="border border-green-500 px-4 py-3 text-right">التاريخ</th>
//               <th className="border border-green-500 px-4 py-3 text-right">اسم الحالة</th>
//               <th className="border border-green-500 px-4 py-3 text-center">المبلغ</th>
//               <th className="border border-green-500 px-4 py-3 text-right">ملاحظة</th>
//               <th className="border border-green-500 px-4 py-3 text-center">إجراءات</th>
//             </tr>
//           </thead>
//           <tbody>
...
//                     {new Date(assistance.date).toLocaleDateString('ar-MA')}
//                   </td>
