...
//       confirmMessage = `⚠️ هل أنت متأكد من تغيير حالة ${memberName} في شهر ${monthName} من "${previousAmount} MRU" إلى "لم يدفع"؟`;
//     } else if (!wasPaid && willBePaid) {
//       // Changing from unpaid to paid
//       confirmMessage = `✅ هل أنت متأكد من تسجيل دفع ${amountPaid} MRU لـ ${memberName} في شهر ${monthName}؟`;
//     } else if (wasPaid && willBePaid && previousAmount !== amountPaid) {
//       // Changing amount
//       confirmMessage = `🔄 هل أنت متأكد من تغيير مبلغ ${memberName} في شهر ${monthName} من ${previousAmount} MRU إلى ${amountPaid} MRU؟`;
//     }
...
//                   <div className="text-[9px] sm:text-[10px] opacity-75">(MRU)</div>
//                 </th>
//               </tr>
//             </thead>
//             <tbody>
//               {members.length === 0 ? (
//                 <tr>
//                   <td colSpan={14} className="text-center py-6 sm:py-8 text-gray-500 text-xs sm:text-sm">
...
//                           افتراضي: {member.monthly_amount} MRU
//                         </span>
//                       )}
//                     </td>
...
//                               if (isAdmin) {
//                                 updatePayment(member.id, monthIndex + 1, newAmount, amountPaid);
//                               }
//                             }}
//                             disabled={!isAdmin}
...
//                         {getMemberYearTotal(member.id).toFixed(0)} MRU
//                       </div>
